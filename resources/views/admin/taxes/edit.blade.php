...
@section('title', 'Edit Tax - L\'ELITE Administration')
        ...
        <nav class="flex" aria-label="Breadcrumb">
            <ol class="flex items-center space-x-2">
                ...
                <li class="flex items-center">
                    ...
                    <span class="text-amber-500">Edit Tax</span>
                </li>
            </ol>
        </nav>
        <h1 class="text-2xl font-bold text-amber-500 mt-4">Edit Tax</h1>
        <p class="text-gray-400 mt-1">Update tax rate information</p>
    </div>
                ...
                <div class="space-y-3">
                    <label class="flex items-center">
                        <input type="radio" 
                               name="type" 
                               value="percentage" 
                               {{ old('type', $tax->type) === 'percentage' ? 'checked' : '' }}
                    ...
                    <label class="flex items-center">
                        <input type="radio" 
                               name="type" 
                               value="fixed" 
                               {{ old('type', $tax->type) === 'fixed' ? 'checked' : '' }}
                               class="w-4 h-4 text-amber-600 bg-[#0f0f0f] border-gray-600 focus:ring-amber-500">
